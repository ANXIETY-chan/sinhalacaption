export default async function handler(req, res) {
  ...
  try {
    ...
    2. පරිශීලකයා දැනටමත් සිංහලෙන් ටයිප් කර ඇත්නම්, එහි ව්‍යාකරණ වැරදි සකසා, අකුරු වැරදි නිවැරදි කර, වඩාත් ආකර්ෂණීය සහ පැහැදිලි සිංහල වාක්‍යයක් බවට පත් කර දෙන්න.
